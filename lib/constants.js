...
export const CURRENT_ISSUE_MARKER = 'Issue 4 (2025)'
export const ISSUE_THREE_MARKER = 'Issue 3 (2024)'
export const ISSUE_THREE_CATEGORY_NAME = 'issue-3-2024'
export const ISSUE_TWO_MARKER = 'Issue 2 (2024)'
export const ISSUE_TWO_CATEGORY_NAME = 'issue-five'
export const ISSUE_ONE_MARKER = 'Issue 1 (2024)'
export const ISSUE_ONE_CATEGORY_NAME = 'issue-four'
export const SPECIAL_ISSUE_THREE_MARKER = 'Special Issue 3 (2023)';
export const SPECIAL_ISSUE_THREE_CATEGORY_NAME = 'special-issue-three'
export const SPECIAL_ISSUE_TWO_MARKER = 'Special Issue 2 (2022)';
export const SPECIAL_ISSUE_TWO_CATEGORY_NAME = 'special-issue-two'
export const SPECIAL_ISSUE_ONE_MARKER = 'Special Issue 1 (2021)';
