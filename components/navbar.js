...
export default function Navbar() {
    return (
        <nav className="flex-col sm:flex-row flex items-center md:justify-between justify-center min-w-full bg-uil-accent-two">
            <div className="container mx-auto px-5 py-4 md:flex md:flex-row space-y-2 md:space-y-0 whitespace-nowrap md:align-middle">
                ...
                <a href="/" className="flex flex-col w-18 h-12 xl:absolute sm:right-12 sm:bottom-2 sm:top-2 font-adriane-text-bold text-2xl text-white px-2"><img className="w-full h-full p-1" alt="Ukrainian Institute London Logo" src="/images/uil-logo.svg" /> </a>
            </div>
        </nav>
    )
}
