...
export default function Navbar( {slug} ) {
    return (
        <nav className="min-w-full bg-[#FFF5F2]">
            ...
            <div className="container mx-auto px-5 sm:pl-7 pt-0 pb-2 md:flex md:flex-row space-y-2 md:space-y-0 sm:whitespace-nowrap md:align-middle items-center">
                <div className="flex-1 flex justify-start">
                    <a href="/" className="font-adriane-text-bold text-2xl sm:text-2xl py-1 sm:py-0 text-white bg-uil-key px-2">London Ukrainian Review</a>
                </div>
